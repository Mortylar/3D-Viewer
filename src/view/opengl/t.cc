...
static void init_buffers (GLuint *vao_out, GLuint *buffer_out, GLuint* el_buff) {
  GLuint vao, buffer, element_buffer;
...
static void realize (GtkWidget *widget) {
  ...
  init_buffers (NULL, &position_buffer, &element_buffer);
...
static void activate(GtkApplication* app, gpointer user_data) {
 ...
 // gtk_grid_attach(GTK_GRID(grid), area, 0,0,1,1);
  area = do_glarea(window);
